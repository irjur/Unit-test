...
class TestBooksCollector:
    ...
    def test_set_book_rating_rating_is_equal_entered_9(self):
        ...
        assert collector.get_book_rating('Властелин колец: Братство кольца') == 9
    ...
    def test_get_books_with_specific_rating_books_only_rating_9(self):
        ...
        assert len(collector.get_books_with_specific_rating(9)) == 2 \
               and 'Властелин колец: Братство кольца' in collector.get_books_with_specific_rating(9) \
               and 'Властелин колец: Возвращение короля' in collector.get_books_with_specific_rating(9)
    ...
    def test_add_book_in_favorites_add_new_book(self):
        ...
        assert 'Властелин колец: Братство кольца' in collector.get_list_of_favorites_books()
